...
#
# Generated by export_simulation on Wed May 28 21:22:49 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './tx1_delay_profile_rom.sh' script.

./tx1_delay_profile_rom.sh -reset_run
...
./tx1_delay_profile_rom.sh -noclean_files

For more information on the script, please type './tx1_delay_profile_rom.sh -help'.
