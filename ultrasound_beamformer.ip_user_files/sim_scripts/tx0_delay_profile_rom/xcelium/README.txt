...
#
# Generated by export_simulation on Wed May 28 21:21:01 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './tx0_delay_profile_rom.sh' script.

./tx0_delay_profile_rom.sh -reset_run
...
./tx0_delay_profile_rom.sh -noclean_files

For more information on the script, please type './tx0_delay_profile_rom.sh -help'.
